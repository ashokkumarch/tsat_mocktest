...
class ConnectionManager
{
	...
	{
		return $this->byId( "yellowsoft_tsat_cgl_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "yellowsoft_tsat_cgl_at_localhost";
		$data["connName"] = "yellowsoft_tsat_cgl at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;yellowsoft_tsat_cgl;;1"; //currently unused

		$this->_connectionsIdByName["yellowsoft_tsat_cgl at localhost"] = "yellowsoft_tsat_cgl_at_localhost";
...
$host="localhost"; // specify if remote host or leave as localhost
$user="root"; // specify mysql username
$pwd="YuppTV@12345";    // specify mysql password
$port="3306"; // specify port if running ssl
$sys_dbname="yellowsoft_tsat_cgl";
...
;
		...
		$connectionsData["yellowsoft_tsat_cgl_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["category"] = "yellowsoft_tsat_cgl_at_localhost";
		$connectionsIds["questions"] = "yellowsoft_tsat_cgl_at_localhost";
		$connectionsIds["users"] = "yellowsoft_tsat_cgl_at_localhost";
		$connectionsIds["registrations"] = "yellowsoft_tsat_cgl_at_localhost";

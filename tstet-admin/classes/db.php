...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "yellowsoft_tsat_cgl_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "category", "varname" => "yellowsoft_tsat_cgl_at_localhost__category", "altvarname" => "category", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
			$dalTables[$conn->connId][] = array("name" => "questions", "varname" => "yellowsoft_tsat_cgl_at_localhost__questions", "altvarname" => "questions", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
			$dalTables[$conn->connId][] = array("name" => "registrations", "varname" => "yellowsoft_tsat_cgl_at_localhost__registrations", "altvarname" => "registrations", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
			$dalTables[$conn->connId][] = array("name" => "sub_category", "varname" => "yellowsoft_tsat_cgl_at_localhost__sub_category", "altvarname" => "sub_category", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "yellowsoft_tsat_cgl_at_localhost__users", "altvarname" => "users", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
		}
	}

...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "category" ] = array( "url" => "category", "type" => 0 );
	$projectEntitiesReverse[ "category" ] = "category";
	$projectEntities[ "questions" ] = array( "url" => "questions", "type" => 0 );
	$projectEntitiesReverse[ "questions" ] = "questions";
	$projectEntities[ "users" ] = array( "url" => "users", "type" => 0 );
	$projectEntitiesReverse[ "users" ] = "users";
	$projectEntities[ "registrations" ] = array( "url" => "registrations", "type" => 0 );
	$projectEntitiesReverse[ "registrations" ] = "registrations";
	$projectEntities[ "sub_category" ] = array( "url" => "sub_category", "type" => 0 );
	$projectEntitiesReverse[ "sub_category" ] = "sub_category";
}

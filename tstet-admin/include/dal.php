...
class tDAL
{
	var $tblyellowsoft_tsat_cgl_at_localhost__category;
	var $tblyellowsoft_tsat_cgl_at_localhost__questions;
	var $tblyellowsoft_tsat_cgl_at_localhost__registrations;
	var $tblyellowsoft_tsat_cgl_at_localhost__sub_category;
	var $tblyellowsoft_tsat_cgl_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "category", "varname" => "yellowsoft_tsat_cgl_at_localhost__category", "altvarname" => "category", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
		$this->lstTables[] = array("name" => "questions", "varname" => "yellowsoft_tsat_cgl_at_localhost__questions", "altvarname" => "questions", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
		$this->lstTables[] = array("name" => "registrations", "varname" => "yellowsoft_tsat_cgl_at_localhost__registrations", "altvarname" => "registrations", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
		$this->lstTables[] = array("name" => "sub_category", "varname" => "yellowsoft_tsat_cgl_at_localhost__sub_category", "altvarname" => "sub_category", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "yellowsoft_tsat_cgl_at_localhost__users", "altvarname" => "users", "connId" => "yellowsoft_tsat_cgl_at_localhost", "schema" => "", "connName" => "yellowsoft_tsat_cgl at localhost");
	}

<div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
         <button type="button" class="btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#model">Add Image</button>
              ...
              <table id="datatable" class="table table-bordered">
                ...
                <tbody id="information">
                    ...
                    <tr>
                         ...
                         <td><a href="javascript:void(0)" id="status<?php echo $value['id'];?>" onclick="return status(<?php echo $value['id'];?>,'gallery')"><?php if($value['status']==1){echo 'Active';}else{echo 'Inactive';}?></a></td>
                         <td>
                         <a href="javascript:void(0)" onclick="getinfo('gallery','<?php echo $value['id'];?>')"  data-toggle="modal" data-target="#model" title="Edit"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
                         <a href="<?php echo base_url($this->folder_key.'/gallery/delete/'.$value['id']);?>" onClick="return confirm('Are you sure you want to delete ?')" title="Delete" class=""><i class="fa fa-trash-o text-danger"></i></a> 
                         </td>
                    </tr>
                    <?php }?>
                </tbody>
    ...
    <div class="modal fade" id="model">
      <div class="modal-dialog modal-lg">
        ...
        <?php echo form_open_multipart(base_url($this->folder_key.'/gallery/submit'),array('id' => 'form')); ?>
...
$('#form').on('submit', function(e){
    ...
    $.ajax({
     type: 'POST',
     url: '<?php echo base_url($this->folder_key.'/gallery/submit');?>',            
